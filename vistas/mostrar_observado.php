...
<body>
    ...
    <div class="container">
        <h1 id="titulo">PETETE - OBSERVADO</h1>
    </div>


  <?php
  require_once "../modelos/Peteteobservado.php";
$petete = new Peteteobservado();

$rspta = $petete->listarpeteteobservado($_GET["id"]);
...
{  
  $idpeteteobservado=$reg->idpeteteobservado;
  $clase=$reg->clase;
  $marca=$reg->marca;
  $tipo=$reg->tipo;
  $color=$reg->color;
    ...
    <div class="row panel-fondo">
        <div class="col-md-3" id="panel">
            <div class="row" id="panel-2">
                ...
                <input value="<?php echo $idpeteteobservado ?>" type="text" id="clasev">
                </div>
            </div>
            <div class="row" id="panel-2">
            ...
            <div class="row">
                <div class="col" id="search-container"><button class="btn btn-primary btn-lg" type="button"><a style="color:white"  href="../vistas/peteteobservado.php">nuevo</a></button> </div>
                <div class="col" id="search-container"><button class="btn btn-primary btn-lg" type="button"><a style="color:white"  href="../vistas/peteteobservado.php">buscar</a></button></div>
            </div>
        </div>
        <div class="col-md-9"> 
            <div class="row">
