...
function guardaryeditar(e)
{
	...
	$.ajax({
		url: "../ajax/petete.php?op=guardaryeditar",
	    type: "POST",
	    data: formData,
	    contentType: false,
	    processData: false,
...
function mostrar(idpetete)
{
	$.post("../ajax/petete.php?op=mostrar",{idpetete : idpetete}, function(data, status)
	{
		data = JSON.parse(data);		
		mostrarform(true);

		$("#idpetete").val(data.idpetete);
...
function desactivar(idpetete)
{
	bootbox.confirm("¿Está Seguro de desactivar el artículo?", function(result){
		if(result)
        {
        	$.post("../ajax/petete.php?op=desactivar", {idpetete : idpetete}, function(e){
        		bootbox.alert(e);
	            tabla.ajax.reload();
        	});	
        }
...
function activar(idpetete)
{
	bootbox.confirm("¿Está Seguro de activar el Artículo?", function(result){
		if(result)
        {
        	$.post("../ajax/petete.php?op=activar", {idpetete : idpetete}, function(e){
        		bootbox.alert(e);
	            tabla.ajax.reload();
        	});	
        }
